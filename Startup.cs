...
namespace FMSystem
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<FMSystemContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("FMSystemContext")));

            services.AddDbContext<fmsContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("fmsContext")));
        }
